export const translations = {
    en: {
        landing: {
            ...
            tip: "ℹ️ <strong>Tip:</strong> These values set your total budget. You'll plan exactly how to use them next.",
    ...
    sv: {
        landing: {
            ...
            tip: "ℹ️ <strong>Tips:</strong> Dessa värden sätter din totala budget. Du planerar exakt hur de ska användas i nästa steg.",
